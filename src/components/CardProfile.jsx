...
export default function CardProfile({ image, title, price }) {
    ...
    <>
        <div className="w-full bg-[#FFFFF2] flex flex-col rounded overflow-hidden hover:shadow-xl transition-shadow duration-300 gap-2 p-2 relative">
            ...
            <h1 className="absolute text-white font-bold mx-2 shadow-2xl">{availableText}</h1>
            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
                ...
                {available && 
                <button onClick={sold} className="flex justify-center items-center gap-2 border w-full sm:w-auto border p-2 mt-2 truncate text-white rounded bg-[green] text-start tranistion-colors duration-300 hover:bg-[#02E49B] hover:text-black">
                    <FaCheck className="shrink-0"/>Mark as Sold
