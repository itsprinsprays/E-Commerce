...
import PEPants from "../assets/PEPants.png"
...
const products = [
  ...
  { image: PE, title: "PE Uniform Set", price: "$49.99", name: "Robert Arpia", gmail: "robert.arpia@cvsu.edu.ph" },
  { image: PEPants, title: "PE Pants", price: "200", name: "Ryhlle Cabatac", gmail: "ryhllevincent.cabatac@cvsu.edu.ph" }
]
